...
public class ArmMotorSubsystem extends SubsystemBase{ 
    ...
    public static int kSlot = 0; private Timer timer = new Timer(); 

    public ArmMotorSubsystem(){ 
        defaultConfig.smartCurrentLimit(3,10,100); 
        ...
        armMotor.getClosedLoopController().setReference(0, ControlType.kVoltage); timer.start(); 
    } 
