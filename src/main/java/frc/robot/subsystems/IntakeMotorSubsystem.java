...
public class IntakeMotorSubsystem extends SubsystemBase{ 
    ...
    //     ClosedLoopSlot loopSlot = slotFromInt(IntakeMotorSubsystem.kSlot);
    
    //     if (loopSlot != null) {
    //         intakeMotor.getClosedLoopController().setReference(
    //             position,
    //             ControlType.kPosition,
    //             loopSlot
    //         );
    //     } else {
    //         System.err.println("Invalid PID slot: " + IntakeMotorSubsystem.kSlot);
    //     }
    // }
    ...
    @Override public void periodic() { 
            ...
            // }else if (slot == 3){ // intakeMotor.getClosedLoopController().setReference(position, ControlType.kPosition,ClosedLoopSlot.kSlot3); 
            // } 
            // } 
